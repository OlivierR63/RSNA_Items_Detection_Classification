...
# Constants for consistent test shapes
TEST_MAX_RECORDS = 25
TEST_BATCH_SIZE = 2
TEST_SERIES_DEPTH = 5
...
class TestLumbarDicomTFRecordDataset:
    ...
    def test_generate_tfrecord_dataset_structure(
        ...
        with ExitStack() as stack:
            ...
            mock_parse = stack.enter_context(patch(f'{MODULE_PATH}.parse_tfrecord_single_element'))
            ...
            mock_process = stack.enter_context(patch(f'{MODULE_PATH}.process_study_multi_series'))
            ...
            mock_format = stack.enter_context(patch(f"{MODULE_PATH}.format_for_model"))
